  ...
  <nav class="navbar navbar-inverse top-bar navbar-fixed-top">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#"><img src="../imgs/logo.png" width="10%"> </a>
      </div>
    ...
    <div class="left-container" id="left-container">
      ...
      <div class="left-sidebar" id="show-nav">
        <ul id="side" class="side-nav">
          <li class="panel">
            <a id="panel1" href="javascript:;" data-toggle="collapse" data-target="#Dashboard"> <i class="fa fa-dashboard"></i> accueil
          ...
          <li class="panel">
            <a id="Create_Users" href="javascript:;" data-toggle="collapse" data-target="#Create Users"> <i class="fa fa-bar-chart-o"></i> Create Users
    ...
    <div class="right-container" id="right-container">
        ...
        <div class="row">
            ...
            <ul class="list-inline pull-right mini-stat">
							<li>
								<h5>Inscrit à la newsletter <span class="stat-value color-blue"><i class="fa fa-plus-circle"></i> 81,450</span></h5>
								
							</li>
							<li>
								<h5>page vue <span class="stat-value color-green"><i class="fa fa-plus-circle"></i> 150,743</span></h5>
								
							</li>
							<li>
								<h5>vue ce mois-ci <span class="stat-value color-orang"><i class="fa fa-plus-circle"></i> 43,748</span></h5>
